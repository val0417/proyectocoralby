...
<?php
        if($_POST){
          ...
          try {
            ...
            print("<script>alert('Error al eliminar producto: " . $e->getMessage() . "');</script>");
        }
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-ui-checks"></i><span class="app-menu__label">Forms</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item active" href="form-components.html"><i class="icon bi bi-circle-fill"></i> Form Components</a></li>
...
<div class="container">
    ...
    <div class="alert alert-danger" role="alert">
      <b>Aviso:</b> El producto será eliminado permanentemente.
    </div>

   <form action="eliminar.php" method="post">
      <div class="form-group">
        <label for="txtcodigo">Ingrese codigo</label>
        <input type="text" class="form-control" name="txtcodigo" placeholder="codigo" required>
      </div> <br>
